                ...
                @foreach($cartItems as $index => $cartItem)
                    <tr>
                        ...
                        {{-- <td>
                            ...
                            <input type="number" class="quantity-input" data-cart-item="{{ $cartItem->id }}" value="{{ $cartItem->quantity }}" min="1">
                            <button onclick="increaseQuantity({{ $cartItem->id }})">+</button>
                        </td> --}}

                        <td>
                            <button onclick="decreaseQuantity({{ $cartItem->id }})">-</button>
                            <input type="number" class="quantity-input" data-cart-item="{{ $cartItem->id }}" data-user-id="{{ $cartItem->user_id }}" data-product-id="{{ $cartItem->product_id }}" value="{{ $cartItem->quantity }}" min="1">
                            <button onclick="increaseQuantity({{ $cartItem->id }})">+</button>
                        </td>
