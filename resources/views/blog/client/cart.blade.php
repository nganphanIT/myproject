...
@section('content')
    <div class="content">
        ...
        <div id="customerForm" class="customer-form">
            ...
            <form action="{{ url('/customer-info/store') }}" method="POST" id="customerInfoForm">
                @csrf
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-vintage" onclick="reloadPage()" id='order_confirm'>Đặt hàng</button>
